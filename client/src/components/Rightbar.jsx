...
const Rightbar = () => {
    return (
        <Box flex={2} p={2} sx={{display: {xs:"none", sm: "block"}}}>
            <Box sx={{position: "fixed"}} width={320}>
                ...
                <AvatarGroup max={7}>
                    ...
                    <Avatar alt="Remy Sharp" src="https://material-ui.com/static/images/avatar/9.jpg" />
                    <Avatar alt="Travis Howard" src="https://material-ui.com/static/images/avatar/10.jpg" />
                </AvatarGroup>
                ...
                <Typography variant="h6" fontWeight={100} mt={2}>Your Conversations</Typography>
